...
public class Game extends Screen {
    ...
    private Texture CrossHairSelectIcon;
    private Texture CrossHairIcon;
    ...
    public Game(Main main) {
        ...
        CrossHairSelectIcon.use();
        CrossHairIcon = e3d.getTexture("/images/crosshair.png", null);
        CrossHairIcon.use();
    ...
    public void render() {
        ...
        if(!isPaused()){
            ...
            if(toActivate != null){
                currentCursor = CrossHairSelectIcon;
            }
            else{
                currentCursor = CrossHairIcon;
            }
            float sizeh = Math.max(1, Math.round(Math.min(w, h) / 60f / currentCursor.h)) * currentCursor.h;
            float sizew = sizeh * currentCursor.w / currentCursor.h;

            main.hudRender.drawRect(currentCursor,
